...
#sawirka xabada
xabad = pygame.transform.scale(pygame.image.load('XABAD.png'),[10,10])
...
class hero:
	...
	def shoot(self):
		...
		for xabado in self.guns:
			xabado.move()
			if xabado.off_screen():
				xabado.remove(xabado)
#---------------------------------------------------------------------
...
class gun_machanic:
	...
	#functionkan wuxuu delete gareenayaa xabada marka ee darbiga dhafto
	#sababtoo ah memory badan ayee ku fadhisaneesaa haddi saas lagu wado
	def off_screen(self):
